...
##-----------------------------------------------------------------------------#            
#            
#                # combine dataframes in parallel
##                df_combine = df_combine.append(df_select)
#                
#                # store this
#                # make multiple, by count
#                df_select_emissivity = df_select['emissivity']
#                
#                print df_select
#                
#
#                
#                # add new column and some value at index 
#                df_select.loc[519, 'New Column Title'] = "some value"
#                
#                df.loc[[0,3],'Z'] = 3
##-----------------------------------------------------------------------------#
## find effective wavelength; will be different, so factor for all cases
## 10.9000
#df_select = df[(df['wavelength'] == 10.9)]
#
## 10.8940
#df_select = df[(df['wavelength'] == 10.894)]
##-----------------------------------------------------------------------------#
#
#
#df.dtypes
#df_result = df['wavelength'].between(10.9 + .5, 10.9 - .5)
#
##convert 'object' series to numeric
##df = pd.to_numeric(df['wavelength'], errors='coerce')
##pd.to_numeric(df['reflectance'], errors='coerce')
#
#
#
#
